...
Java_com_example_product360photo_YOLOv4_init(JNIEnv *env, jclass, jobject assetManager, jboolean useGPU) {
...
Java_com_example_product360photo_YOLOv4_detect(JNIEnv *env, jclass, jobject image, jdouble threshold, jdouble nms_threshold) {

    auto result = YoloV4::detector->detect(env, image, threshold, nms_threshold);
    auto box_cls = env->FindClass("com/example/product360photo/model/Box");
